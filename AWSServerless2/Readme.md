...
WORKDIR /src
COPY ["AWSServerless2.csproj", "AWSServerless2/"]
RUN dotnet restore "AWSServerless2/AWSServerless2.csproj"

WORKDIR "/src/AWSServerless2"
COPY . .
RUN dotnet build "AWSServerless2.csproj" --configuration Release --output /app/build

FROM build AS publish
RUN dotnet publish "AWSServerless2.csproj" \
